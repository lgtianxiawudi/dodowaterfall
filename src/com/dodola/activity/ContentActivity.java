...
public class ContentActivity extends ActivityBase implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		scrollView = (MyScrollView) findViewById(R.id.newsScrollview);
		...
		runnable=new Runnable() {
			...
			public void run() {
				...
				scrollView.scrollBy(0, 3);
				handler2.postDelayed(runnable, 50);
			}
		};
	...
	public void onAutoScroll(int l, int t, int oldl, int oldt) {
		...
		if(t-oldt<3){
			new ContentFootTask(ContentActivity.this)
			.execute("http://www.duitang.com/album/369270/masn/p/4/24/");
			System.out.println("ONBOTTOM"+(t-oldt));
		}
	}
